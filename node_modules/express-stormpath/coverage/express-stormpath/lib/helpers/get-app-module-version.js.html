...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (modulePath) {
    var loadedModule = require(path.join(modulePath, 'package.json'));
    <span class="missing-if-branch" title="else path not taken" >E</span>if (loadedModule) {
