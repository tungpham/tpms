...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!config || !config.web || !config.web.register) {</span>
<span class="cstat-no" title="statement not covered" >    return callback([]);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  async.forEachOf(config.web.register.form.fields || {}, <span class="fstat-no" title="function not covered" >function (field, fieldName, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (field &amp;&amp; field.enabled &amp;&amp; field.required) {</span>
<span class="cstat-no" title="statement not covered" >      field.name = fieldName;</span>
